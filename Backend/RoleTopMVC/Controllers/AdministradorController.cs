                ...
                foreach (var item in agendamentos) {
                    switch (item.Status) {
                        case (uint) StatusAgendamentoEnum.APROVADO:
                            item.StatusString = StatusAgendamentoEnum.APROVADO.ToString();
                            dvm.PedidosAprovados++;
                            break;
                        case (uint) StatusAgendamentoEnum.REPROVADO:
                            item.StatusString = StatusAgendamentoEnum.REPROVADO.ToString();
                            dvm.PedidosReprovados++;
                            break;
                        case (uint) StatusAgendamentoEnum.CANCELADO:
                            item.StatusString = StatusAgendamentoEnum.CANCELADO.ToString();
                            dvm.PedidosCancelados++;
                            break;
                        case (uint) StatusAgendamentoEnum.PENDENTE:
                            item.StatusString = StatusAgendamentoEnum.PENDENTE.ToString();
